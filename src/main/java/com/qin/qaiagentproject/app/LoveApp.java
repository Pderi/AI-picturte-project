...
import com.qin.qaiagentproject.advisor.ReReadingAdvisor;
...
import static org.springframework.ai.chat.client.advisor.AbstractChatMemoryAdvisor.CHAT_MEMORY_RETRIEVE_SIZE_KEY;
    ...
    public class LoveApp {
        ...
        /*public LoveApp(ChatModel dashscopeChatModel) {
            ...
            chatClient = ChatClient.builder(dashscopeChatModel)
                    ...
                    .defaultAdvisors(
                            ...
                            new ReReadingAdvisor(),//注意:开启推理增强后成本翻倍
                            new MyLoggerAdvisor()
                    )
                    .build();
        }*/
        ...
        //@Resource
       // private VectorStore pgVectorVectorStore;//将向量存在向量数据库中
        @Resource
        private VectorStore loveAppVectorStore;//将向量存在本地内存中
